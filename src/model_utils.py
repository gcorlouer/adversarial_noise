...
class ModelLoader:
    ...
    def predict(self, input_tensor: torch.Tensor, top_k: int = 1) -> Tuple[List[int], List[float]]:
        ...
        if len(input_tensor.shape) != 4:
            raise ValueError(f"Expected 4D tensor [1,C,H,W], got shape {input_tensor.shape}")
